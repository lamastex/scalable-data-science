...
This project fine-tunes the Segment Anything Model to fluorescence microsopy images.
Previously, not many segmentations (or good ones) seem to have been available for this data.
This seemed to have involved quite a bit of implementation.
The results seem pretty good.
The process is made scalable with Ray.
