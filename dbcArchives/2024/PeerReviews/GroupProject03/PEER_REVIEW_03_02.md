...
I think this was an interesting project with a quite clear presentation. Easy to follow what your inspiration came from and how you wanted to do a scalable project, hence a 2 in both scalability and presentation. Initially I was impressed by the readme file which clearly showed me how to run things on my own and it seemed nicely organized. But the more I looked into the code, and the tons of directories, the more I didn't know where to look in a reasonable time frame. One of the notebooks had some nice markdown files, but I think both of them could be improved by adding more comments in the code and making it more comprehenisble. The same can be said for the python scripts that you suggest us to run. Also, it might make sense to clean up the other directories or clearly put a sort of map how to navigate them and make sure they all are readable and runable. It looks like the uploaded notebook wasn't succesfully ran either. Otherwise, great job and a very impressive project with a lot of effort!
