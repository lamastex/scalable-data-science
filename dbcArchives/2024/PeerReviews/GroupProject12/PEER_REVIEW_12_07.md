...
The were a few reasons for the lower score: 
- there was no link to the presentation
- the code repo could have benefitted from individual ReadMe pages within each folder
- the ReadMe for the project was minimal and did not provide a succinct overview of the challenge that the project was addressing

The project seems technically really impressive, but it is difficult to understand without more descriptions.
