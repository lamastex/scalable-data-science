...
// MAGIC %md # Article topics in retweet network
// MAGIC Scalable data science course project by Li Caldeira Balkeståhl and Mariama Jaiteh
// MAGIC 
...
// MAGIC %md As can be seen, this is quite slow, it already takes 15 seconds for only 13 URL's. For a 1% sample of our dataset (about 2500 URL's), it took about 20 minutes.
// MAGIC 
...
// MAGIC %md Access the topics from the fit, translate the word index to words (strings) and get a dataframe of topics described by the most probable words
...
// MAGIC %md The K-means clusters center
...
// MAGIC %md By looking at some articles from each cluster:
// MAGIC * Cluster 0: Diverse
// MAGIC * Cluster 5: US related (politics, economics)

// COMMAND ----------

// MAGIC %md ### 2. K-means using TF-IDF with HashingTF
// MAGIC 
