...
# MAGIC 
# MAGIC In this notebook, an implementation of [ICNet](https://arxiv.org/pdf/1704.08545.pdf) is presented which is an architecture whitch uses a trade-off between complexity and inference time efficiently. The architecture is evaluated against the Oxford pets dataset.

# COMMAND ----------

# MAGIC %md
# MAGIC Below, functions for data manipulation are defined, ensuring that the images inputted to the model is of appropriate format.
...
# MAGIC %md
# MAGIC Here the data is loaded from Tensorflow datasets.
...
# MAGIC %md
# MAGIC Method for performing cascade feature fusion. See https://arxiv.org/pdf/1704.08545.pdf
