...
# MAGIC %sh
# MAGIC wget https://github.com/olgeet/UCluster/archive/refs/heads/master.zip
# MAGIC unzip master.zip

# COMMAND ----------

# MAGIC %md
# MAGIC Unzip and move original code to 06_LHC_TF1. Copy the entire h5 folder from 06_LHC since it contains already preprocessed h5 files, which have been processed without TF and should be usable with any version.

# COMMAND ----------

# MAGIC %sh 
# MAGIC rm -r 06_LHC_TF1
# MAGIC mkdir 06_LHC_TF1
# MAGIC cd 06_LHC_TF1
# MAGIC mv ../UCluster-master/* .
# MAGIC rm -r ../UCluster-master/ ../master.zip
# MAGIC cp ../06_LHC/h5/* ./h5/

# COMMAND ----------

# MAGIC %sh
# MAGIC ls 06_LHC_TF1/h5

# COMMAND ----------

# MAGIC %md
# MAGIC # The code itself

# COMMAND ----------

# MAGIC %md Imports. Only changed some paths
...
# MAGIC %md
# MAGIC Uses Namespace from argparse instead
...
# MAGIC %md 
# MAGIC Some helper functions (commented in log_string because FOUT doesn't work for some reason)
...
# MAGIC %md
# MAGIC Main training function (nothing changed)
...
# MAGIC %md
# MAGIC Helper functions needed for training (nothing changed)
...
# MAGIC %md
# MAGIC Train one epoch (nothing changed)
...
# MAGIC %md
# MAGIC Evaluate one epoch (nothing changed)
...
# MAGIC %md
# MAGIC Running the training (no file written)
