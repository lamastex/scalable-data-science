...
# MAGIC           \end{cases}"  />
# MAGIC           
# MAGIC where <img src="https://latex.codecogs.com/svg.latex?&space;\lambda, \lambda'" /> are scale factors. Since we always can apply a projective transformation <img src="https://latex.codecogs.com/svg.latex?&space;H"  />  to set one of the cameras to <img src="https://latex.codecogs.com/svg.latex?&space;P_1 = [I \quad 0]" /> and the other to some <img src="https://latex.codecogs.com/svg.latex?&space;P_2 = [A \quad t]" /> we can parameterize the global point <img src="https://latex.codecogs.com/svg.latex?&space;X_i" /> by 
...
# MAGIC 
# MAGIC Taking two points on this line (one of them being <img src="https://latex.codecogs.com/svg.latex?&space;e'" /> using <img src="https://latex.codecogs.com/svg.latex?&space;\lambda = 0" />), 
...
# MAGIC 
# MAGIC unzip /tmp/door.zip -d /tmp/0019/
# MAGIC 
# MAGIC rm -r /tmp/door.zip
...
# MAGIC 
# MAGIC dbutils.fs.rm("dbfs:/datasets/0019/images", true)
# MAGIC 
# MAGIC dbutils.fs.mkdirs("dbfs:/datasets/0019/images")
# MAGIC 
# MAGIC dbutils.fs.cp(localpath, "dbfs:/datasets/0019/images", true)
...
# MAGIC %scala
# MAGIC 
# MAGIC display(dbutils.fs.ls("dbfs:/datasets/0019/images")) 
