...
// MAGIC 
// MAGIC 1. We first get the source text data by scraping and parsing from [http://stateoftheunion.onetwothree.net/texts/index.html](http://stateoftheunion.onetwothree.net/texts/index.html) as explained in 
...
// MAGIC %md
// MAGIC ##### YoutTry: HOMEWORK WordCount 2: `dbutils.fs`
// MAGIC 
...
// MAGIC %md
// MAGIC ## Exercise 2: SouWordCount
// MAGIC 
// MAGIC Count the number of each word across all the "dbfs:/datasets/sou/*.txt" files and output the result as an Array of (word,count) tuples from the most frequent to the least frequent word.
// MAGIC 
// MAGIC This is the same as [Exercise 2 in the local environment](https://github.com/lamastex/scalable-data-science/tree/master/_sds/basics/infrastructure/onpremise/dockerCompose/programs/exercises/sparkSubmit#exercise-2-souwordcount).
