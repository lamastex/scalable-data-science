...
// MAGIC %md
// MAGIC #### YouTry: Top referrers to other 2016 US presidential candidate pages
// MAGIC 
// MAGIC `'Donald_Trump', 'Bernie_Sanders', 'Hillary_Rodham_Clinton', 'Ted_Cruz'`
...
// MAGIC -- YouTry 
// MAGIC ---
// MAGIC -- fill in the right sql query here
...
// MAGIC 
// MAGIC You need to hit the Play Button in next cell and 'Run Cell' exactly once.
