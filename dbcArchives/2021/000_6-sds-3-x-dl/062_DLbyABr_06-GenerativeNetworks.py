...
# MAGIC 
# MAGIC <img src="/files/gan_generated_image_epoch_10.png" width=800>
...
# MAGIC # Where Next?
# MAGIC 
# MAGIC Keep an eye on Medium articles and others at sites like towardsdatascience:
# MAGIC 
# MAGIC Here is one which caught my eve in 2019:
# MAGIC 
# MAGIC  - [AI for trading](https://towardsdatascience.com/aifortrading-2edd6fac689d)
