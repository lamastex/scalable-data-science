...
// MAGIC References:
// MAGIC 
// MAGIC * [GraphFrames User Guide](https://graphframes.github.io/graphframes/docs/_site/user-guide.html)
...
// MAGIC 
// MAGIC These are required naming conventions for vertices and edges in GraphFrames.
...
// MAGIC %md
// MAGIC BTW, A lot more delicate air-traffic arithmetic is possible for a full month of airplane co-trajectories over the radar range of Atlanta, Georgia, one of the busiest airports in the world.
// MAGIC 
