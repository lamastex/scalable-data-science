...
> diamondsDColoredDF\_FromTable: org.apache.spark.sql.DataFrame = \[carat: double, color: string ... 1 more field\]
...
> +--------+--------------------+-----------+ |database| tableName|isTemporary| +--------+--------------------+-----------+ | default| cities\_csv| false| | default| cleaned\_taxes| false| | default|commdettrumpclint...| false| | default| donaldtrumptweets| false| | default| linkage| false| | default| nations| false| | default| newmplist| false| | default| ny\_baby\_names| false| | default| nzmpsandparty| false| | default| pos\_neg\_category| false| | default| rna| false| | default| samh| false| | default| table1| false| | default| test\_table| false| | default| uscites| false| | | diamonds| true| +--------+--------------------+-----------+
