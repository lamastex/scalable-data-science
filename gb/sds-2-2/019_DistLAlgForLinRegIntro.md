...
**HOMEWORK:** \* read: <http://arxiv.org/pdf/1509.02256.pdf> (also see References and Appendix A). \* and go through the notebooks here: [Data Types - MLlib Programming Guide](/#workspace/scalable-data-science/xtraResources/ProgGuides2_2/MLlibProgrammingGuide/dataTypes/000_dataTypesProgGuide)
...
**Lessons:** \* parallelism makes our computation faster \* but network communication slows us down
