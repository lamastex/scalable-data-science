...
2. Those with Windows (may be unsupported for Windows 7!) should follow the instructions in the following URL and test that the jupyter notebook server launches successfully:
