...
#ls -al /root/temp
echo $MDBOOKdir/zipped/$1.dbc
mkdir -p $MDBOOKdir/mdbooks
stack exec pinot -- --from databricks --to mdbook $MDBOOKdir/zipped/$1.dbc -o $MDBOOKdir/mdbooks/$1/src/contents
