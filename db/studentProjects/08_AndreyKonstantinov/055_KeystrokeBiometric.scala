...
// MAGIC 
// MAGIC ## Keystroke Biometric
// MAGIC ### Scalable data science project by [Andrey Konstantinov](https://www.linkedin.com/in/andrey-konstantinov-38234531)
// MAGIC 
...
// MAGIC 
// MAGIC [![sds/uji/studentProjects/08_AndreyKonstantinov/055_KeystrokeBiometric](http://img.youtube.com/vi/rnpa6YsDXWY/0.jpg)](https://www.youtube.com/v/rnpa6YsDXWY?rel=0&autoplay=1&modestbranding=1&start=2586&end=3956)

// COMMAND ----------

// MAGIC %md
// MAGIC # Keystroke Biometric
// MAGIC Completed by Andrey Konstantinov for Scalable Data Science course for University of Canterbury, Christchurch
// MAGIC 2016/05
// MAGIC 
// MAGIC ### What is keystroke biometric?
// MAGIC https://en.wikipedia.org/wiki/Keystroke_dynamics
// MAGIC 
// MAGIC ### Why?
// MAGIC - detect if an account is shared by multiple people (to enforce licensing)
// MAGIC - detect if an account is accidently used by a second person when a device is left unattended (to block it / reask for password)
// MAGIC - waive the second form authentication factor for less-risky opertions (when keystroke dynamic is strong)
// MAGIC - categorise PC user to experienced and not experienced
// MAGIC 
// MAGIC ### Existing work
// MAGIC Comparing Anomaly-Detection Algorithms for Keystroke Dynamics
// MAGIC - http://www.cs.cmu.edu/~maxion/pubs/KillourhyMaxion09.pdf
// MAGIC - http://www.cs.cmu.edu/~keystroke/
// MAGIC 
// MAGIC ### Related (mouse movements dynamics)
// MAGIC - bots filtering (https://www.google.com/recaptcha/intro/index.html)
// MAGIC - sliding bar on signin form (http://www.aliexpress.com/)
// MAGIC 
// MAGIC ### Scope of this notebook
// MAGIC - overview of the data source
// MAGIC - statistical evaluation of an algorithm (improved anomaly detection algorithm based on Manhattan distance from average)
// MAGIC - simulation of 'creditability score' to reduce error rate
// MAGIC - results review
// MAGIC 
// MAGIC ### Source code (scala) and interactive demo application (typescript/javascript)
// MAGIC - https://gitlab.com/avkonst/keystroke-dynamics-course
