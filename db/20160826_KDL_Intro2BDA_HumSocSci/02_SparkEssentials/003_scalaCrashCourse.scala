// Databricks notebook source exported at Sun, 28 Aug 2016 15:39:47 UTC
// MAGIC %md
// MAGIC 
...
// MAGIC %md
// MAGIC The recorded Uji ![Image of Uji, Dogen's Time-Being](https://raw.githubusercontent.com/raazesh-sainudiin/scalable-data-science/master/images/UjiTimeBeingDogen.png "uji") of a past version of this notebook:
// MAGIC 
...
// MAGIC %md
// MAGIC ## See databricks_guide -> Welcome to Databricks
// MAGIC 
// MAGIC The guide is an excellent resource and helps one keep up with the fast-evolving Apache Spark over the convenience of databricks GUI and front-end.
