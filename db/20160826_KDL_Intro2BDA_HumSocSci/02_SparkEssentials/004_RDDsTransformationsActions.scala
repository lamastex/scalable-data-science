// Databricks notebook source exported at Sun, 28 Aug 2016 15:51:07 UTC
// MAGIC %md
// MAGIC 
...
// MAGIC 
// MAGIC **NOTE:** The links to other notebook may not work in a different shard depending on where you uploaded the 'scalable-data-science' archive to! This can be easily fixed by correcting the directory containing 'scalable-data-science' folder. Here it is assumed to be in 'Workspace' folder. This NOTE won't keep reappearing :)
// MAGIC 
