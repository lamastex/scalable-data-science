// Databricks notebook source exported at Wed, 24 Feb 2016 04:23:49 UTC
// MAGIC %md
// MAGIC # Here is a list of interesting papers from ACM that may help choose a project
...
// MAGIC  2. Techniques and Applications for Sentiment Analysis
...
// MAGIC  3. Looking back at big data (Digital humanities)
...
// MAGIC  4. Compitational Epidemiology
...
// MAGIC  * Big Data and its techincal challenges
...
// MAGIC  * Big Data Meets Big Science
...
// MAGIC   * (Extra Reading)
// MAGIC  * Reshaping Terrorist Networks
