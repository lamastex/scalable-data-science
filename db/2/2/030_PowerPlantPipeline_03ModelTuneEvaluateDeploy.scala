...
// MAGIC %md
// MAGIC This can take between 5 - 15 minutes in a shard with 6 workers depending on other workloads (may be longer in the Community Edition).
...
// MAGIC %md
// MAGIC Note that the root mean squared error is smaller now due to the ensemble of 120 trees from Gradient Boosting!
// MAGIC 
...
displayHTML(frameIt("https://databricks.com/blog/2016/05/31/apache-spark-2-0-preview-machine-learning-model-persistence.html",500))
