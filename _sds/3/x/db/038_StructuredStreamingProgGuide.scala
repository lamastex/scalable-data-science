...
// MAGIC 
// MAGIC -   [Structured Streaming Programming Guide](https://spark.apache.org/docs/3.0.1/structured-streaming-programming-guide.html)   
...
// MAGIC API](https://spark.apache.org/docs/3.0.1/sql-programming-guide.html) in
...
dbutils.fs.head("/datasets/streamingFiles/30_04.log")
