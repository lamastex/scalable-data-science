...
// MAGIC 
// MAGIC * for Spark 3.0.1 use maven coordinates: `org.isarnproject:isarn-sketches-spark_2.12:0.5.0-sp3.0`
// MAGIC 
...
// MAGIC %md
// MAGIC Let's t-digest this `data` using a user-defined function `udf` evaluated below.
