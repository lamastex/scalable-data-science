...
# MAGIC %md
# MAGIC # Fundamental Matrix

# COMMAND ----------

# MAGIC %md
# MAGIC 
# MAGIC Group members: Linn Öström, Patrik Persson, Johan Oxenstierna, and Alexander Dürr
# MAGIC 
# MAGIC **Link to our video explaining the 1) theory, 2) preprocessing the dataset, 3) algorithm and 4) results**
# MAGIC [https://drive.google.com/drive/folders/1zEWj6JsJEUu9f8Q5Xy_avwxQ3yJ9oI7Z?usp=sharing](https://drive.google.com/drive/folders/1zEWj6JsJEUu9f8Q5Xy_avwxQ3yJ9oI7Z?usp=sharing)
# MAGIC 
# MAGIC alternatively: [https://youtu.be/eJ2LDtNad08](https://youtu.be/eJ2LDtNad08)
...
# MAGIC %md
# MAGIC ## Results
# MAGIC 1. Time complexity of our algorithm
# MAGIC 2. Visualizing epipolar lines
# MAGIC 3. Visualizing matching points
