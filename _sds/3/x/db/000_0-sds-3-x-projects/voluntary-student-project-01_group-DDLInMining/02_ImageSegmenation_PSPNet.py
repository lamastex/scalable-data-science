...
# MAGIC %md
# MAGIC Loading the datasets to memory and displaying an example of an image and an image mask.
...
# MAGIC %md
# MAGIC Creating the PSPModel with three classes, 16 filters, kernel size of (3,3), 'relu' as the activation function and with image height and width of 128 pixels.
...
# MAGIC %md
# MAGIC The losses and accuracies of each epoch is plotted to visualize the performance of the model.
