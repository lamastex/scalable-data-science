...
// MAGIC 
// MAGIC **not tested in Spark 2.2+ or 3.x yet (see 034 notebook for syntactic issues, if any)**
...
// MAGIC %md
// MAGIC 
// MAGIC Let's get a bird's eye view of LDA from http://www.cs.columbia.edu/~blei/papers/Blei2012.pdf next.
// MAGIC 
...
// MAGIC %sh 
// MAGIC wget http://ir.dcs.gla.ac.uk/resources/linguistic_utils/stop_words -O /tmp/stopwords # uncomment '//' at the beginning and repeat only if needed again

// COMMAND ----------

// MAGIC %fs 
// MAGIC cp file:/tmp/stopwords dbfs:/tmp/stopwords 
...
// MAGIC %sh wget http://lamastex.org/datasets/public/nlp/cornell_movie_dialogs_corpus.tgz
...
// MAGIC %sh tar zxvf cornell_movie_dialogs_corpus.tgz
...
// MAGIC %sh pwd && ls -al cornell_movie_dialogs_corpus
