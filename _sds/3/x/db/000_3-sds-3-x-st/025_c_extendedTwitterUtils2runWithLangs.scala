...
// MAGIC %md
// MAGIC ## Extended TwitterUtils with Language
// MAGIC 
// MAGIC 
...
// MAGIC 
// MAGIC This notebook is mainly left to show how one can adapt one of the exsiting notebooks for twitter experiemnts to cahnge the design of the experiment itself. Similarly, one can extend further into the twitter4j functions and methods we are wrapping into Scala here.
// MAGIC 
