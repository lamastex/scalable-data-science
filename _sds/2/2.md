...
## Support
The course is supported by databricks academic partners programme ([databricks](https://databricks.com/) is the UC, Berkeley startup founded by the creators of [Apache Spark™](http://spark.apache.org/), a fast and general engine for large-scale data processing) and [Amazon Web Services Educate](https://aws.amazon.com/education/awseducate/) and will train data scientists to meet the current needs of Stockholm's data industry through feedback from the AI and Data Analytics Centre of Excellence at [Combient AB](https://combient.com/), a Joint Venture between 11 swedish global enterprises within the Wallenberg sphere, headquartered in Sweden.


**The course is currently under construction. So the exact form and structure may change slightly from the planned outline below in the next several days.**
{: .notice--danger}
...
## Learning Outcomes -- Introduction to Data Science

At the conclusion of the course, students should be able to:
- Describe what Data Science *is* and the *current* skill sets needed to be a data scientist.
...
## Learning Outcomes -- Fundamentals of Data Science

Introduction to Data Science is a pre-requisite for this course.
...
The course consists of lectures (two times a week, 100 minutes each), and involves a set of assignments (about 4) and a substantial project.  The course project could take one of the following forms:
