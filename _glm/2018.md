...
Here is a [sample exam](arch/sampleExam2018.pdf) and its [solution](arch/sampleExam2018sol.pdf).
...
In your databricks community edition account import `.dbc` or `.html` file from:

 - [https://github.com/lamastex/scalable-data-science/tree/master/_glm/2018/db/IntroToSparkRforGLM.dbc](https://github.com/lamastex/scalable-data-science/tree/master/_glm/2018/db/)
