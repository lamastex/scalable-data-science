...
- Morning Tutorials: 0900-1200 hours
  - Tutorial on *Privacy-preserving Data Mining: Privacy versus Utility* by [Julián Salas Piñón](http://transfer.rdi.uoc.edu/en/researcher/salas-pin-julin) of K-riptography and Information Security for Open Networks (KISON) Research Group at The Internet Interdisciplinary Institute (IN3), Open University of Catalunya (UOC), Barcelona, Spain.
...
## Abstracts of Tutorils and Seminars

- **Abstract of Tutorial on Privacy-preserving Data Mining:** While data mining may have enormous benefits to science, business and society. At the same time, the large amount of data collected and analyzed may reveal a lot about our private selves, from our habits or personality traits, to personal information that we may prefer to keep in private.
To motivate privacy enhancing techniques, we will present attacks to privacy that where possible due to naïve 
anonymization of medical records, AOL internet search queries, Netflix movie ratings and NYC-taxis geo-located data.
