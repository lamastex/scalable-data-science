...
The lectures are based on [Combinatorial Methods in Density Estimation by Luc Devroye and Gábor Lugosi](https://www.springer.com/gp/book/9780387951171), with an emphasis on the problem of selecting from k density estimates with *Universal Performance Guarantees* via minimum distance estimates that bound the Vapnik-Chervonenkis shatter coefficients over the Yatracos class of all k(k-1) Scheffe sets.
