...
**Prepare your laptop** (try it on your own and help one another, team-up with a mate if you do not have a laptop): 

**SOFTWARE**: We will be using SageMath/Python ecosystem for the course. 
...
I would like to customize the course for you! SO would prefer to do the content week-by-week. But, if you want to have some idea of the structure for the course then follow Chapters 1-9, 11-14, 17-18 in one of my books in progress:
...
This is a mathematically more mature variant of UC Berkeley's most popular freshman course aimed at covering the Syllabus for Uppsala's Inference Theory 1:
