...
// MAGIC %md
// MAGIC ## Tweet Transmission Tree Implementation:
// MAGIC #### Dataset: The United States 2016 3rd Presidential Debate Streamed Tweets

// COMMAND ----------

// MAGIC %md
// MAGIC ** Step 1: To retrieve the dataset from AWS S3, the authors credentials are verified for mounting.**
// MAGIC 
// MAGIC Note: This step can be skipped if your tweet data is in another directory other than AWS S3 such as dbfs or hdfs or databricks local driver.
// MAGIC 
// MAGIC The S3 credentials can also be called and runned from another notebook (for example, if the notebook is named "AWS_Credentials")
...
display(StreamedTweetsPQ.take(5))
...
//% run "Users/email@gmail.com/src2run/TTTDFfunctions"
